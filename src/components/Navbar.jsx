    ...
    <AppBar position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
              ...
              {pages.map((page) => (
                <MenuItem key={page} onClick={handleCloseNavMenu}>
                  <Typography textAlign="center"
                              onClick={()=> handlePageClick(page)}>{page}</Typography>
                </MenuItem>
              ))}
            </Menu>
          </Box>
          ...
          <p style={{fontSize:"1.4rem", fontWeight:"Bold"}}>{`WELCOME ELIF'S BLOG APP`} </p>
          </Box> 
          <Box sx={{ flexGrow: 0 }}>
            ...
            >
              {
                ...
                (settingsIn.map((setting) => (
                  <MenuItem key={setting} onClick={handleCloseUserMenu}>
                    <Typography textAlign="center"
                        onClick={()=> handleSettingsClick(setting)}>{setting}</Typography>
                  </MenuItem>
                ))
                ) : 
